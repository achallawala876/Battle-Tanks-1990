...
module lab62_soc_mm_interconnect_0 (
		...
		input  wire        Execute_reset_reset_bridge_in_reset_reset,      //      Execute_reset_reset_bridge_in_reset.reset
	...
	wire  [108:0] execute_s1_agent_rf_source_data;                                                    // Execute_s1_agent:rf_source_data -> Execute_s1_agent_rsp_fifo:in_data
	...
	wire  [108:0] execute_s1_agent_rsp_fifo_out_data;                                                 // Execute_s1_agent_rsp_fifo:out_data -> Execute_s1_agent:rf_sink_data
	...
	wire  [107:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> Execute_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // Execute_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [16:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> Execute_s1_agent:cp_channel
	...
	wire          cmd_mux_015_src_valid;                                                              // cmd_mux_015:src_valid -> keycode1_s1_agent:cp_valid
	wire  [107:0] cmd_mux_015_src_data;                                                               // cmd_mux_015:src_data -> keycode1_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                              // keycode1_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [16:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> keycode1_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                                      // cmd_mux_015:src_startofpacket -> keycode1_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                        // cmd_mux_015:src_endofpacket -> keycode1_s1_agent:cp_endofpacket
	...
	wire  [107:0] execute_s1_agent_rp_data;                                                           // Execute_s1_agent:rp_data -> router_008:sink_data
	...
	wire          keycode1_s1_agent_rp_valid;                                                         // keycode1_s1_agent:rp_valid -> router_017:sink_valid
	wire  [107:0] keycode1_s1_agent_rp_data;                                                          // keycode1_s1_agent:rp_data -> router_017:sink_data
	wire          keycode1_s1_agent_rp_ready;                                                         // router_017:sink_ready -> keycode1_s1_agent:rp_ready
	wire          keycode1_s1_agent_rp_startofpacket;                                                 // keycode1_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          keycode1_s1_agent_rp_endofpacket;                                                   // keycode1_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire          keycode1_s1_agent_rdata_fifo_src_valid;                                             // keycode1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_015:in_0_valid
	wire   [33:0] keycode1_s1_agent_rdata_fifo_src_data;                                              // keycode1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_015:in_0_data
	wire          keycode1_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_015:in_0_ready -> keycode1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_015_out_0_valid;                                                  // avalon_st_adapter_015:out_0_valid -> keycode1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_015_out_0_data;                                                   // avalon_st_adapter_015:out_0_data -> keycode1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_015_out_0_ready;                                                  // keycode1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_015:out_0_ready
	wire    [0:0] avalon_st_adapter_015_out_0_error;                                                  // avalon_st_adapter_015:out_0_error -> keycode1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (Execute_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                               //             clk.clk
		.reset                   (Execute_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab62_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (Execute_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
